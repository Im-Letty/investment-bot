...
(function(){
  ...
  var digestCopy={
    ja:{title:'経済ニュース',date:'掲載対象日',noDigest:'本日のまとめはまだ掲載されていません。記事は「もっと詳しく」から読めます。',more:'もっと詳しく',close:'閉じる',intro:'気になる配信元を開いて、見出しを読む。',source:'配信元',count:function(n){return n+'件の見出し';},noToday:'本日発表された経済ニュースは、まだ確認できていません。',supplements:'日付付きの補足',supplement:'補足',original:'元の記事を読む',published:'発表'},
